...
interface PublicState {
  ...
  setThemeValue: (theme: ThemeType) => void; // 设置主题
  setFullscreen: (isFullscreen: boolean) => void; // 设置全屏
  setRefresh: (isRefresh: boolean) => void; // 设置重新加载
  setRefreshPage: (isRefreshPage: boolean) => void; // 设置重新加载页面
}
